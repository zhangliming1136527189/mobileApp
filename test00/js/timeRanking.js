...
$(function(){
    ...
    var width=($("#tab-type-inner").width()-2)/2;
...
function draw(args) {
    ...
    if(sessionStorage.supporttype =="bug"){
        for (var i = 0; i < data.length; i++) {
            if (i >= 0 && i <= 2) {
                if(i==0){
                    $("#ranking-content ul").append("<li><span><img src=\"../img/icon_first.png\"/></span><span>" + data[i][0] + "</span><span>" + data[i][1] + "小时</span></li>")

                }else if(i==1){
                    $("#ranking-content ul").append("<li><span><img src=\"../img/icon_second.png\"/></span><span>" + data[i][0] + "</span><span>" + data[i][1] + "小时</span></li>")
                }else if(i==2){
                    $("#ranking-content ul").append("<li><span><img src=\"../img/icon_third.png\"/></span><span>" + data[i][0] + "</span><span>" + data[i][1] + "小时</span></li>")

                }
            } else {
                if (i % 2 == 0) {
                    $("#ranking-content ul").append("<li><span style='font-size:0.18rem;color:#FF9900'>" + (i + 1) + ".</span><span>" + data[i][0] + "</span><span>" + data[i][1] + "小时</span></li>")
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (i >= 0 && i <= 2) {
                if(i==0){
                    $("#ranking-content ul").append("<li><span><img src=\"../img/icon_first.png\"/></span><span>" + data[i][0] + "</span><span>" + data[i][1] + "人天</span></li>")

                }else if(i==1){
                    $("#ranking-content ul").append("<li><span><img src=\"../img/icon_second.png\"/></span><span>" + data[i][0] + "</span><span>" + data[i][1] + "人天</span></li>")

                }else if(i==2){
                    $("#ranking-content ul").append("<li><span><img src=\"../img/icon_third.png\"/></span><span>" + data[i][0] + "</span><span>" + data[i][1] + "人天</span></li>")
                }
            } else {
                if (i % 2 == 0) {
                    $("#ranking-content ul").append("<li><span style='font-size:0.18rem;color:#FF9900'>" + (i + 1) + ".</span><span>" + data[i][0] + "</span><span>" + data[i][1] + "人天</span></li>")
